...
interface SimpleAlignedCylinderProps {
  className?: string
}

export default function SimpleAlignedCylinder({ className = '' }: SimpleAlignedCylinderProps) {
  ...
  return (
    <div className={`simple-aligned-cylinder ${className}`}>
      <div 
        ref={mountRef} 
