...
interface AlignedCylinderWithMaskProps {
  className?: string
}

export default function AlignedCylinderWithMask({ className = '' }: AlignedCylinderWithMaskProps) {
  ...
  useEffect(() => {
    ...
    cylinderGeometry.rotateX(Math.PI / 2) // Rotate to align with Z-axis
  ...
  return (
    <div className={`aligned-cylinder-with-mask ${className}`}>
